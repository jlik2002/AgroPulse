...
def _to_anomaly(field_id: uuid.UUID, period: AnomalyPeriod) -> Anomaly:
    return Anomaly(
        ...
        anomaly_score=period.anomaly_score,
        level_z=period.level_z,
        slope_z=period.slope_z,
        historical_z=period.historical_z,
        change_point_nearby=period.change_point_nearby,
